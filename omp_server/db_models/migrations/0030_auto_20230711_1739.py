# Generated by Django 3.1.4 on 2022-08-22 11:13
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='selfhealingsetting',
            name='fresh_rate',
            field=models.IntegerField(default=10, validators=[django.core.validators.MaxValueValidator(60)],
                                      verbose_name='周期内采集告警消息频次'),
        ),
        migrations.AddField(
            model_name='selfhealingsetting',
            name='instance_tp',
        ...
        migrations.AlterField(
            ...
            name='retain_path',
            field=models.TextField(blank=True, default='/data/omp/data/backup/', max_length=256, null=True,
                                   verbose_name='文件保存路径'),
        ),
        migrations.AlterField(
            model_name='selfhealinghistory',
        ...
        migrations.AlterField(
            ...
            field=models.IntegerField(default=5, validators=[django.core.validators.MaxValueValidator(20)],
                                      verbose_name='最多自愈操作次数'),
        ),
    ]
